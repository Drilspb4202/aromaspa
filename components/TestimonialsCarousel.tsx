...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: "Анна М.",
    text: "Aroma Spa Studio изменило мою жизнь! Ароматерапия помогла мне справиться со стрессом и улучшить сон. Я очень благодарна команде за их профессионализм и заботу."
  },
  {
    id: 2,
    name: "Сергей К.",
  ...
  },
  {
    id: 3,
    name: "Елена В.",
    text: "АромаЙога в Aroma Spa Studio - это нечто особенное. Сочетание йоги и ароматерапии создает невероятную атмосферу гармонии и спокойствия."
  }
]
