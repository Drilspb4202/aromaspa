...
const benefits = [
  {
    ...
    description: "Каждая капля эфирного масла — это как прикосновение природы к Вашей душе. Устали и суеты? Закройте глаза, вдохните, и почувствуйте, как напряжение растворяется в ароматах покоя."
  },
  {
    icon: Moon,
    title: "Улучшение сна",
