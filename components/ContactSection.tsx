...
Дополнительная информация: ${formData.additional_info || 'Нет'}`;
  ...
  return (
    <section id="контакты" className="py-12 md:py-16 relative z-10">
          ...
          >
            <Card className="bg-gradient-to-br from-purple-900/40 via-fuchsia-900/40 to-pink-900/40 border-fuchsia-500/30 backdrop-blur-sm flex-grow shadow-xl">
              <CardContent className="p-5 md:p-6 flex flex-col h-full">
                <div className="mb-4">
                  <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-fuchsia-400 to-purple-400 bg-clip-text text-transparent mb-1">
                    Записаться на услугу
                  </h3>
                  <p className="text-gray-300 text-xs md:text-sm">Заполните форму и мы свяжемся с вами</p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-3 flex-grow flex flex-col">
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <MessageSquare className="absolute left-4 top-3 text-fuchsia-400 w-5 h-5" />
                      <Textarea
                        name="additional_info"
                        placeholder="Дополнительная информация (необязательно)"
                        className="bg-white/10 backdrop-blur-sm border-fuchsia-500/30 text-white placeholder:text-gray-400 pl-12 resize-none min-h-[80px] rounded-xl focus:border-fuchsia-400 focus:ring-2 focus:ring-fuchsia-400/50 transition-all"
                        rows={3}
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-fuchsia-600 to-purple-700 hover:from-fuchsia-500 hover:to-purple-600 text-white transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-fuchsia-500/50 border-2 border-fuchsia-400 mt-auto rounded-xl py-4 md:py-5 text-sm md:text-base font-semibold"
          ...
          >
            ...
            <Card className="bg-purple-900/30 border-fuchsia-500/30">
              <CardContent className="p-5 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold text-fuchsia-400 mb-4">Наши контакты</h3>
                <div className="space-y-2.5">
                  <div className="flex items-start space-x-3">
                    <MapPin className="w-5 h-5 text-fuchsia-500 flex-shrink-0 mt-0.5" />
                    <div className="flex flex-col gap-1.5">
                      <p className="text-gray-300 text-sm md:text-base">г. СПб, Советский пр., д. 12, кв/оф. 2 (тер. Усть-Славянка)</p>
                      <div className="flex gap-3">
                        <a 
                          href="https://2gis.ru/spb/geo/70000001101166106" 
                          target="_blank" 
                          rel="noopener noreferrer" 
                          className="text-fuchsia-400 hover:text-fuchsia-300 transition-colors text-xs md:text-sm"
                        >
                          2GIS →
                        </a>
                        <a 
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="tel:+79956000122" className="text-gray-300 hover:text-fuchsia-500 transition-colors text-sm md:text-base">8 995 6000 12 2</a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <BrandTelegram className="w-5 h-5 text-fuchsia-500" />
                    <a href="https://t.me/+79956000122" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-fuchsia-500 transition-colors text-sm md:text-base">Telegram</a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-fuchsia-500" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="https://wa.me/79956000122" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-fuchsia-500 transition-colors text-sm md:text-base">WhatsApp</a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <BrandTelegram className="w-5 h-5 text-fuchsia-500" />
                    <a href="https://my.winwinbot.com/bot/1/EfirniyMir_Bot?REFID=6441213" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-fuchsia-500 transition-colors text-sm md:text-base">Сообщество "НАШЕ ЗДОРОВЬЕ" в Telegram</a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <ShoppingBag className="w-5 h-5 text-fuchsia-500" />
                    <a href="https://office.doterra.com/Application/index.cfm" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-fuchsia-500 transition-colors text-sm md:text-base">Купить эфирные масла с 25% скидкой</a>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-purple-900/30 border-fuchsia-500/30">
              <CardContent className="p-5 md:p-6">
                <h3 className="text-xl md:text-2xl font-bold text-fuchsia-400 mb-3">Часы работы</h3>
                <div className="text-gray-300">
                  <p className="text-sm md:text-base">По предварительной записи</p>
                </div>
              </CardContent>
            </Card>
